...
import { run as runWorkTimeP1aContract } from "./work/timeP1aContract.test";
...
import { run as runBotReferentSelectionMentionChain } from "./bot/referentSelectionMentionChain.test";
...
import { run as runWorkGmailReferentCandidates } from "./work/gmailReferentCandidates.test";
...
const suites: { name: string; run: () => Promise<{ pass: number; fail: number }> }[] = [
  ...
  { name: "work/timeP1aContract", run: runWorkTimeP1aContract },
  ...
  { name: "bot/referentSelectionMentionChain", run: runBotReferentSelectionMentionChain },
  ...
  { name: "work/gmailReferentCandidates", run: runWorkGmailReferentCandidates },
