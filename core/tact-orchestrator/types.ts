...
import type { ResolvedWorkIntent } from "../tact-work/types";
...
export interface OrchestrationRequest {
  ...
  // WORK-P1: an internal, server-derived semantic boundary. It is never
  // accepted from a browser or provider callback.
